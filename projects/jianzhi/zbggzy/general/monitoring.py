...
class WebsiteRedisStorage:
    ...
    def store_website_data(self, province: str, city: str, website_data: dict[str, Any]) -> bool:
        """
        存储网站数据到Redis
        """
        try:
    ...
    def update_website_data(self, province: str, city: str, webname: str, updates: dict[str, Any]) -> bool:
        """
        更新网站数据
        """
        try:
